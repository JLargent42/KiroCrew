...
function LaunchProgressCard({ job, onCancel, onSignin, onSigninRefresh, cancelling, refreshingSignin, signinRefreshError, alreadyLoggedIn }: {
  job: LaunchJob
  ...
  signinRefreshError: string | null
        ...
        <div className="mt-3 rounded-md border border-accent-subtle bg-bg-elevated px-3 py-2.5">
          ...
          {alreadyLoggedIn ? (
            ...
            <>
              ...
              {signinRefreshError && (
                <p className="mt-1.5 text-[12px] text-danger">{i18nT('pages.settings.remoteCrewPanel.new_code_error')}</p>
              )}
            </>
          )}
        </div>
        ...
        <div className="space-y-4">
          ...
          {activeJob && (
            <LaunchProgressCard
              ...
              signinRefreshError={signinRefreshMutation.isError ? 'error' : null}
