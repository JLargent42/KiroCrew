...
async function main() {
  ...
  if (!/^1 session is answered by another machine/.test(notice1)) throw new Error(`frame 1 notice: ${notice1}`)
  ...
  if (!/^2 sessions are answered by another machine/.test(notice2)) throw new Error(`frame 2 notice: ${notice2}`)
