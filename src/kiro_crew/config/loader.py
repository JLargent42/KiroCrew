    ...
    def _load_resolved(cls) -> tuple[KiroCrewConfig, int]:
        ...
        cfg = cls(
            agent=AgentConfig(
                ...
                task_dispatch_window=_safe_int(
                    agent_data.get("task_dispatch_window", 64), 64, 1, 4096
                ),
                ...
                controller_sample_secs=_safe_int(
                    agent_data.get("controller_sample_secs", 5), 5, 1, 300
                ),
            ...
            mcp_gateway=McpGatewayConfig(
                ...
                host_budget_max_fds=max(
                    0, _safe_int(mcp_gateway_data.get("host_budget_max_fds", 0), 0)
                ),
                poolable_servers=[
